...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_proceed_to_checkout' ) ) {
	...
	function woocommerce_widget_shopping_cart_proceed_to_checkout() {
		echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward">Đặt hàng</a>';
	}
}
	...
	function woocommerce_checkout_payment() {
		...
		wc_get_template(
			...
			array(
				...
				'order_button_text'  => apply_filters( 'woocommerce_order_button_text', 'Đặt hàng' ),
			)
		);
	}
}
...
function wc_empty_cart_message() {
	echo '<p class="cart-empty woocommerce-info">' . wp_kses_post( apply_filters( 'wc_empty_cart_message', 'Giỏ hàng trống' ) ) . '</p>';
}
