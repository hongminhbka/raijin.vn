			...
			apply_filters(
				...
				array(
					'labels'              => array(
						...
						'singular_name'         => __( 'Sản phẩm', 'woocommerce' ),
						'all_items'             => __( 'Sản phẩm', 'woocommerce' ),
						'menu_name'             => _x( 'Sản phẩm', 'Admin menu name', 'woocommerce' ),
						'add_new'               => __( 'Thêm mới', 'woocommerce' ),
						'add_new_item'          => __( 'Thêm mới', 'woocommerce' ),
						'edit'                  => __( 'Sửa', 'woocommerce' ),
						'edit_item'             => __( 'Sửa', 'woocommerce' ),
						'new_item'              => __( 'Thêm mới', 'woocommerce' ),
						'view_item'             => __( 'Xem', 'woocommerce' ),
						'view_items'            => __( 'Xem', 'woocommerce' ),
